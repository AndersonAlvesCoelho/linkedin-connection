...
import { login } from '../puppeteerModule/start.js';
import { delay } from '../utils/delay.js';
const { buttonsPost, nextPage, buttonShowMorePosts, followers } = browserConstants;
...
export class Browser {
	...
	async connectWithPeoples(amount, term, note = false) {
		try {
			const { connectButton, actions, getName, btnNoSendNote } = browserConstants.connect;
